...
```
git clone https://github.com/rdkcentral/meta-bolt-app-examples.git
cd meta-bolt-app-examples
```
...
```
bolt push <remote> com.rdkcentral.base+0.2.0                # here <remote> is the Hostname or alias of a device accessible via SSH in non-interactive mode
